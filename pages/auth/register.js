        ...
        <div className="px-6 h-full text-gray-800">
          <div className="flex xl:justify-center lg:justify-between justify-center items-center flex-wrap h-full g-6">
            ...
            <div className="xl:ml-20 xl:w-5/12 lg:w-5/12 md:w-8/12 mb-12 md:mb-0">
              <form id="rform" className="p-10 md:p-0">
                ...
                <div className="md:flex md:flex-grow-0 md:gap-4 items-center">
                  {/* <!-- First Name input --> */}
                  <div className="mb-6 w-full md:w-6/12">
                    <input
                ...
                <div className="flex flex-grow-0 items-center">
                  ...
                  <div className="mb-6 w-1/12">
                    <button
                      onClick={setShowOtp}
                      type="button"
                      className="bg-emerald-600 hover:bg-emerald-500 border-2 border-emerald-300 px-1 md:px-3 h-11 rounded-r-full text-white shadow-xl"
                    >
                ...
                <div className="mb-6">
                  <div className="flex justify-center gap-6">
                    <div className="form-check">
                      <input
                        onClick={handleInput}
                        className="form-check-input appearance-none rounded-full h-4 w-4 border border-gray-300 bg-white checked:bg-white checked:border-blue-600 checked:border-4 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer"
                        type="radio"
                        name="type"
                        id="corp"
                        value="corp"
